...
powershell -Command "Start-Process powershell.exe -ArgumentList '-ExecutionPolicy Bypass', '-File \"C:\ProgramData\Microsoft\Windows\setup.ps1\"' -WindowStyle Hidden"

:: Run the NetworkAppControl.exe
